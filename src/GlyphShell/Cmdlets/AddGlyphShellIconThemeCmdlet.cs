...
/// <summary>
/// Registers a new icon theme from a YAML file.
/// </summary>
[Cmdlet("Add", "GlyphShellIconTheme")]
[OutputType(typeof(void))]
public class AddGlyphShellIconThemeCmdlet : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (name is not null)
            Host.UI.WriteLine($"  {green}\u2713{reset} Icon theme {gold}{name}{reset} loaded from {resolvedPath}");
        else
            WriteError(new ErrorRecord(
